// /frontend/src/components/pages/admin/ManageUsers/OrganizationSelection.tsx
/**
 * @file Component for selecting an organization to manage users.
 * @description This component displays a grid of organizations, allowing the admin to select one to manage its users.
 */
...
interface OrganizationSelectionProps {
  ...
  onSelectOrg: (org: OrganizationResponse) => void;
}
