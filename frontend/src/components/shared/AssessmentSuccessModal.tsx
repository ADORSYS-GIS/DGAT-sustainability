      ...
      <DialogContent className="max-w-md">
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="text-xl font-semibold text-gray-900">
            {t('assessment.successTitle', { defaultValue: 'Assessment Created Successfully!' })}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center space-x-2 text-gray-600">
            ...
            <p className="text-sm">
              {t('assessment.successMessage', { 
                defaultValue: 'Your users are going to answer the assessment assigned to them.' 
              })}
            </p>
          </div>
          ...
          <div className="pt-4">
            ...
            >
              <span>{t('assessment.returnToDashboard', { defaultValue: 'Return to Dashboard' })}</span>
