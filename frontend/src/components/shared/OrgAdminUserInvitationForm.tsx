      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">{t('invitationFlow.orgAdminOnlyCreateUsers')}</p>
          </div>

          <div className="space-y-2">
            <Label htmlFor="categories">{t('userInvitation.categories')}</Label>
            <div className="flex flex-wrap gap-2 mt-2">
              {isLoadingCategories ? (
                <p>{t('invitationFlow.loadingCategories')}</p>
              ) : (
