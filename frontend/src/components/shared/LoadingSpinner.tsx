...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({
  ...
  const containerClasses = fullPage
    ? "fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white/40 backdrop-blur-md transition-all duration-500"
    : "flex flex-col items-center justify-center py-16 w-full animate-in fade-in duration-700";
