...
export default function DraftSubmissions() {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700">{t("user.draftSubmissions.yesNoResponse")}</span>
        ...
        {/* Percentage */}
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700">{t("user.draftSubmissions.percentageResponse")}</span>
        ...
        {/* Text Input */}
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700">{t("user.draftSubmissions.textResponse")}</span>
          <Textarea
        ...
        {/* File List */}
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700">{t("user.draftSubmissions.attachedFiles")}</span>
          {files.length > 0 ? (
            ...
            <span className="text-sm text-gray-500 italic">{t("user.draftSubmissions.noFilesAttached")}</span>
          )}
        </div>
      </div>
    );
  ...
  if (isLoading) {
    return <LoadingSpinner size="hero" fullPage text={t("user.draftSubmissions.loadingDraftSubmissions")} />;
  }
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 mb-2">
                    {selectedSubmission.assessment_name || t("user.draftSubmissions.assessment")}
                  </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{t("user.draftSubmissions.organization")}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{t("user.draftSubmissions.submitted")}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">
                      {selectedSubmission.content?.responses?.length || 0} {t("user.draftSubmissions.responses")}
                    </p>
                    <p className="text-xs text-gray-500">{t("user.draftSubmissions.questionsAnswered")}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-semibold text-gray-900">{t("user.draftSubmissions.assessmentResponses")}</h2>
                  <p className="text-sm text-gray-500 italic">{t("user.draftSubmissions.clickToExpand")}</p>
                </div>
                ...
                {categories.length > 0 ? (
                        ...
                        <AccordionTrigger className="w-full px-6 py-4 hover:no-underline bg-gradient-to-r from-blue-50/50 to-indigo-50/50 hover:from-blue-50 hover:to-indigo-50 transition-colors border-b border-gray-100">
                          <div className="flex items-center text-left">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-blue-600/70">{groupedByCategory[category].length} {t("user.draftSubmissions.responses")}</p>
                            </div>
                          </div>
                        </AccordionTrigger>
                  ...
                  <div className="text-center py-12 text-gray-500 bg-white rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <p>{t("user.draftSubmissions.noResponsesAvailable")}</p>
                  </div>
                )}
              </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                        <div className="flex items-center space-x-2">
                          ...
                          <span>{submission.assessment_name || t("user.draftSubmissions.assessment")}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Calendar className="h-4 w-4" />
                          <span>{t("user.draftSubmissions.submitted")} {new Date(submission.submitted_at).toLocaleDateString()}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Users className="h-4 w-4" />
                          <span>{submission.content?.responses?.length || 0} {t("user.draftSubmissions.responses")}</span>
                        </div>
                      </div>
                    </div>
