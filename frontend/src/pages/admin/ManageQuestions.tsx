...
import { Question, Category, Template } from "@/services/indexedDB";
import {
  createQuestion,
  updateQuestion,
  deleteQuestion,
...
export const ManageQuestions: React.FC = () => {
  ...
  const loadQuestions = async () => {
    ...
    try {
      const questionData = await getQuestionsByTemplate(selectedTemplate);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const text = {
        en: formData.text_en,
        zu: formData.text_zu || formData.text_en, // Fallback to English if Zulu not provided
      };
          ...
          {selectedTemplate && (
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle>Questions for {selectedTemplateName}</CardTitle>
