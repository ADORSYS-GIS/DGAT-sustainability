...
export const ManageQuestions: React.FC = () => {
  ...
  const { data: questions = [] } = useQuery<Question[]>({
    queryKey: ["questions", SUSTAINABILITY_TEMPLATE_ID],
    queryFn: () => getQuestionsByTemplate(SUSTAINABILITY_TEMPLATE_ID),
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingQuestion) {
      updateMutation.mutate({ ...editingQuestion, ...questionData });
    } else {
