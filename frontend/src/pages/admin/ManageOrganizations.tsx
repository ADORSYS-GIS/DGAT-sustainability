...
export const ManageOrganizations: React.FC = () => {
  ...
  const [formData, setFormData] = useState<OrganizationCreateRequest>({
    name: "",
    domains: [{ name: "" }],
    redirectUrl: import.meta.env.VITE_ORGANIZATION_REDIRECT_URL || "https://ec2-3-120-151-17.eu-central-1.compute.amazonaws.com/",
    enabled: "true",
  ...
  const handleEdit = (org: OrganizationResponseFixed) => {
    ...
    setFormData({
      ...
      redirectUrl: org.redirectUrl || import.meta.env.VITE_ORGANIZATION_REDIRECT_URL || "https://ec2-3-120-151-17.eu-central-1.compute.amazonaws.com/",
