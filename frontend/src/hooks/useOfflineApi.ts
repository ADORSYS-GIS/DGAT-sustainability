  ...
  const createQuestion = useCallback(
    async (
      ...
      try {
        ...
        const offlineQuestion = DataTransformationService.transformQuestion(
          tempQuestionForTransform,
        );
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to create question");
  ...
  const updateQuestion = useCallback(
    async (
      ...
      try {
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to update question");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
    ...
    async (
      ...
      try {
        ...
        const latestRevisionId =
          existingQuestion.latest_revision?.question_revision_id;
        if (!latestRevisionId) {
          ...
          async () => {
            ...
            const response =
              await QuestionsService.deleteQuestionsRevisionsByQuestionRevisionId(
                { questionRevisionId: latestRevisionId },
              );
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to delete question");
...
export function useOfflineAssessments() {
  const [data, setData] = useState<{ assessments: Assessment[] }>({
    assessments: [],
  });
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState<Error | null>(null);
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      setError(
        err instanceof Error ? err : new Error("Failed to fetch assessments"),
      );
    } finally {
      setIsLoading(false);
    }
...
export function useOfflineDraftAssessments() {
  const [data, setData] = useState<{ assessments: OfflineAssessment[] }>({
    assessments: [],
  });
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState<Error | null>(null);
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const result = await apiInterceptor.interceptGet(
        () => {
          console.log(
            "🔍 useOfflineDraftAssessments: Making API call with status=draft",
          );
        ...
        async () => {
          ...
          const draftAssessments =
            await offlineDB.getAssessmentsByStatus("draft");
          console.log(
            "🔍 useOfflineDraftAssessments: Raw assessments from IndexedDB:",
            draftAssessments,
          );
      ...
      console.log(
        "🔍 useOfflineDraftAssessments: API response received:",
        result,
      );
      ...
      const transformedResult = {
        assessments: result.assessments
          ...
          .map((assessment) => {
            console.log(
              "🔍 useOfflineDraftAssessments: Processing assessment:",
              assessment,
            );
            return {
              ...assessment,
      ...
      console.log(
        "🔍 useOfflineDraftAssessments: Final transformed result:",
        transformedResult,
      );
      ...
      setError(
        err instanceof Error
          ? err
          : new Error("Failed to fetch draft assessments"),
      );
    } finally {
      setIsLoading(false);
    }
...
export function useOfflineAssessment(assessmentId: string) {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const result = await apiInterceptor.interceptGet(
        () => {
          return AssessmentsService.getAssessmentsByAssessmentId({
            assessmentId,
          });
        },
        async () => {
          ...
          if (!offlineAssessment) {
            ...
            throw new Error(
              `Assessment ${assessmentId} not found. Please try refreshing the page or contact support if the problem persists.`,
            );
          }
...
export function useOfflineAssessmentsMutation() {
  ...
  const createAssessment = useCallback(
    async (
      ...
      try {
        ...
        const result = await apiInterceptor.interceptMutation(
          ...
          async (apiResponse: Record<string, unknown>) => {
            ...
            if (!apiResponse.assessment) {
              ...
              console.warn(
                "Received request data instead of API response - API call may have failed",
              );
              return;
            }
            ...
            if (!realAssessment || !realAssessment.assessment_id) {
              console.error(
                "API did not return a valid assessment:",
                apiResponse,
              );
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to create assessment");
  ...
  const updateAssessment = useCallback(
    async (
      ...
      try {
        ...
        const result = await apiInterceptor.interceptMutation(
          ...
          async (data: Record<string, unknown>) => {
            ...
            const offlineAssessment =
              DataTransformationService.transformAssessment(realAssessment);
            await offlineDB.saveAssessment(offlineAssessment);
          },
          assessment as Record<string, unknown>,
          "assessments",
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to update assessment");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
  ...
  const deleteAssessment = useCallback(
    async (
      ...
      try {
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to delete assessment");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
  ...
  const submitDraftAssessment = useCallback(
    async (
      assessmentId: string,
      options?: {
        onSuccess?: (data: Record<string, unknown>) => void;
      ...
      try {
        ...
        try {
          ...
          console.error(
            "❌ Failed to store draft submission in IndexedDB:",
            storageError,
          );
        ...
        console.log(
          "🔍 submitDraftAssessment: Calling AssessmentsService.postAssessmentsByAssessmentIdDraft for assessmentId:",
          assessmentId,
        );
        const result = await apiInterceptor.interceptMutation(
          () =>
            AssessmentsService.postAssessmentsByAssessmentIdDraft({
              assessmentId,
            }),
          async (apiResponse: Record<string, unknown>) => {
            ...
            if (!realSubmission || !realSubmission.submission_id) {
              console.error(
                "API did not return a valid submission:",
                apiResponse,
              );
              throw new Error("API did not return a valid submission");
            }
            const finalOfflineSubmission =
              DataTransformationService.transformSubmission(realSubmission);
        ...
        const error =
          err instanceof Error
            ? err
            : new Error("Failed to submit draft assessment");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
  ...
  const approveAssessment = useCallback(
    async (
      ...
      try {
        ...
        console.log(
          "🔍 approveAssessment: Calling AssessmentsService.postAssessmentsByAssessmentIdSubmit for assessmentId:",
          assessmentId,
        );
        ...
        if (result && typeof result === "object" && "submission" in result) {
          ...
          if (submission && submission.submission_id) {
            ...
            await offlineDB.saveSubmission(finalOfflineSubmission);
            console.log(
              "🔍 approveAssessment: Updated local submission status to approved",
            );
          }
        }
        ...
        const error =
          err instanceof Error
            ? err
            : new Error("Failed to approve assessment");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
...
export function useOfflineResponses(assessmentId: string) {
  const [data, setData] = useState<{ responses: Response[] }>({
    responses: [],
  });
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState<Error | null>(null);
  ...
  const fetchData = useCallback(async () => {
    if (!assessmentId || assessmentId.trim() === "") {
      console.warn(
        "⚠️ Empty or invalid assessmentId provided to useOfflineResponses:",
        assessmentId,
      );
      setData({ responses: [] });
      setIsLoading(false);
...
export function useOfflineResponsesMutation() {
  ...
  const createResponses = useCallback(
    async (
      assessmentId: string,
      ...
      try {
        ...
        if (!assessmentId || assessmentId.trim() === "") {
          console.error(
            "❌ Invalid assessmentId provided to createResponses:",
            assessmentId,
          );
        ...
        const result = await apiInterceptor.interceptMutation(
          ...
          async (data: Record<string, unknown>) => {
            ...
            if (responsesData && Array.isArray(responsesData)) {
              ...
              const offlineResponses = responsesData.map((r) =>
                DataTransformationService.transformResponse(r as Response),
              );
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to create responses");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
  ...
  const updateResponse = useCallback(
    async (
      ...
      try {
        ...
        if (!assessmentId || assessmentId.trim() === "") {
          console.error(
            "❌ Invalid assessmentId provided to updateResponse:",
            assessmentId,
          );
          throw new Error("Invalid assessment ID provided");
        }
        if (!responseId || responseId.trim() === "") {
          console.error(
            "❌ Invalid responseId provided to updateResponse:",
            responseId,
          );
        ...
        console.log(
          "🔍 Updating response for assessmentId:",
          assessmentId,
          "responseId:",
          responseId,
        );
        ...
        const result = await apiInterceptor.interceptMutation(
          ...
          async (data: Record<string, unknown>) => {
            ...
            const offlineResponse =
              DataTransformationService.transformResponse(responseData);
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to update response");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
  ...
  const deleteResponse = useCallback(
    async (
      ...
      try {
        ...
        if (!assessmentId || assessmentId.trim() === "") {
          console.error(
            "❌ Invalid assessmentId provided to deleteResponse:",
            assessmentId,
          );
          throw new Error("Invalid assessment ID provided");
        }
        if (!responseId || responseId.trim() === "") {
          console.error(
            "❌ Invalid responseId provided to deleteResponse:",
            responseId,
          );
          throw new Error("Invalid response ID provided");
        }
        ...
        console.log(
          "🔍 Deleting response for assessmentId:",
          assessmentId,
          "responseId:",
          responseId,
        );
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to delete response");
        options?.onError?.(error);
        throw error;
      } finally {
        setIsPending(false);
...
export function useOfflineSubmissions() {
  const [data, setData] = useState<{ submissions: Submission[] }>({
    submissions: [],
  });
    ...
    async (
      ...
      try {
        ...
        const result = await apiInterceptor.interceptMutation(
          async () => {
            console.log(
              "🔍 deleteSubmission: Making API call to delete submission",
              submissionId,
            );
            await SubmissionsService.deleteSubmissionsBySubmissionId({
              submissionId,
            });
          ...
          async (data: Record<string, unknown>) => {
            console.log(
              "🔍 deleteSubmission: Using offline fallback - deleting from local storage only",
            );
        ...
        const error =
          err instanceof Error ? err : new Error("Failed to delete submission");
...
export function useOfflineAdminSubmissions() {
  const [data, setData] = useState<{ submissions: AdminSubmissionDetail[] }>({
    submissions: [],
  });
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState<Error | null>(null);
    ...
    try {
      ...
      const result = await apiInterceptor.interceptGet(
        ...
        async () => {
          ...
          const adminSubmissions: AdminSubmissionDetail[] = allSubmissions.map(
            (submission) => ({
              ...
              org_name:
                submission.org_name ||
                "Offline Data - Organization Name Unavailable", // Use stored org_name
              content: {
                assessment: submission.content?.assessment || {
                  assessment_id: submission.assessment_id,
                },
      ...
      console.error(
        "❌ useOfflineAdminSubmissions: Error fetching admin submissions:",
        err,
      );
      setError(
        err instanceof Error
...
export function useOfflineAdminActionPlans() {
  const [data, setData] = useState<ActionPlanListResponse>({
    organizations: [],
  });
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState<Error | null>(null);
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const result = await apiInterceptor.interceptGet(
        ...
        async () => {
          ...
          const offlineRecommendations =
            await offlineDB.getAllRecommendations();
      ...
      setError(
        err instanceof Error
          ? err
          : new Error("Failed to fetch admin action plans"),
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const fetchData = useCallback(async () => {
    try {
        ...
        async () => {
          ...
          for (const report of reports.reports) {
            const transformedRecs =
              DataTransformationService.transformReportToOfflineRecommendations(
                report,
          ...
          return {
            recommendations: allOfflineRecommendations,
            reports: reports.reports,
          }; // Return the transformed data and raw reports
        },
        async () => {
          // Offline fallback: fetch all recommendations from IndexedDB
          const offlineRecommendations =
          ...
          return {
            recommendations: user?.organization
              ? offlineRecommendations.filter(
                  (rec) => rec.organization_id === user.organization,
                )
      ...
      setError(
        err instanceof Error
          ? err
          : new Error("Failed to fetch user recommendations"),
      );
    } finally {
      setIsLoading(false);
    }
    ...
    async (
      ...
      try {
        ...
        const result = await apiInterceptor.interceptMutation(
          ...
          async (apiResponse: Record<string, unknown>) => {
            ...
            const updatedRecommendation =
              await offlineDB.getRecommendation(recommendationId);
            if (
              updatedRecommendation &&
              updatedRecommendation.sync_status === "pending"
            ) {
        ...
        const error =
          err instanceof Error
            ? err
            : new Error("Failed to update recommendation status");
...
export function useOfflineOrganizations() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const result = await apiInterceptor.interceptGet(
        () =>
          OrganizationsService.getAdminOrganizations().then((response) => ({
...
export function useOfflineUsers(organizationId?: string) {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const result = await apiInterceptor.interceptGet(
        () =>
          OrganizationMembersService.getOrganizationsByIdOrgAdminMembers({
            id: organizationId,
          }).then((response) => ({ members: response })),
        () =>
          offlineDB
      ...
      const resultData = result as
        ...
        | OrganizationMember[];
      const filteredResult = Array.isArray(resultData)
        ? resultData
        : resultData.members || [];
      const filteredUsers = filteredResult.filter(
        (user: OrganizationMember) => !user.id?.startsWith("temp_"),
      );
...
export function useOfflineDraftSubmissions() {
  const [data, setData] = useState<{ draft_submissions: unknown[] }>({
    draft_submissions: [],
  });
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState<Error | null>(null);
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.log(
        "🔍 useOfflineDraftSubmissions: Calling AdminService.getDrafts()",
      );
      const result = await apiInterceptor.interceptGet(
        () => {
          console.log(
            "🔍 useOfflineDraftSubmissions: Inside AdminService.getDrafts() call",
          );
          console.log(
            "🔍 useOfflineDraftSubmissions: Timestamp:",
        ...
        () => {
          ...
          return offlineDB.getAllSubmissions().then((submissions) => ({
            draft_submissions: submissions.filter(
      ...
      setError(
        err instanceof Error
          ? err
          : new Error("Failed to fetch draft submissions"),
      );
    } finally {
      setIsLoading(false);
    }
